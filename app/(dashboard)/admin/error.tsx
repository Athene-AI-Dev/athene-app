  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-8 animate-in fade-in zoom-in duration-500 px-6">
      ...
      <div className="space-y-3 max-w-md">
        <h1 className="text-3xl font-black tracking-tight text-foreground">Admin panel error</h1>
        <p className="text-muted-foreground leading-relaxed">
          {error.message || "Failed to load this admin section. Please retry or return to the dashboard."}
        </p>
        {error.digest && (
