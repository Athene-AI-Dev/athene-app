...
async function fetchWorkspaceContent(
  ...
  try {
    ...
    console.error(`[powerbi] Failed to fetch reports for workspace ${workspaceName}:`, err)
  }
  ...
  try {
    ...
    console.error(`[powerbi] Failed to fetch datasets for workspace ${workspaceName}:`, err)
  }
  ...
  try {
    ...
    console.error(`[powerbi] Failed to fetch dashboards for workspace ${workspaceName}:`, err)
  }
...
async function fetchLegacyContent(
  ...
  try {
    ...
    console.error('[powerbi] Legacy reports fetch failed:', err)
  }
  ...
  try {
    ...
    console.error('[powerbi] Legacy datasets fetch failed:', err)
  }
  ...
  try {
    ...
    console.error('[powerbi] Legacy dashboards fetch failed:', err)
  }
